...
print("[AccessibilityHighlight] Script file started loading\n")
...
local function SpawnHighlightLight(key, pawn)
    ...
    print(string.format("[AccessibilityHighlight] [LIGHT] spawned for %s\n", key))
end
...
local function ApplyChams(key, pawn)
    ...
    print(string.format("[AccessibilityHighlight] [CHAMS] processed %d component(s) on %s\n", count, key))
...
local function SpawnHighlightBox(key, pawn)
    ...
    print(string.format("[AccessibilityHighlight] [BOX] spawned for %s\n", key))
end
...
RegisterHook("/Script/Engine.AudioComponent:Play", function(Context)
    ...
    if string.find(string.lower(soundName), WHISTLE_SOUND_KEYWORD) then
        ...
        if not wasAlreadyHighlighted then
            print(string.format("[AccessibilityHighlight] Whistle detected on %s (mode=%s)\n", key, HIGHLIGHT_MODE))
        end
    end
end)
...
print(string.format("[AccessibilityHighlight] Loaded. Current mode: %s (edit HIGHLIGHT_MODE at top of script to change)\n", HIGHLIGHT_MODE))
